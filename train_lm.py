...
from models.mde6d import mde6d
...
def train():
    ...
    trainer = Trainer(
        ...
        model_fn,
        optimizer,
        checkpoint_name=os.path.join(checkpoint_fd, "mde6d_%s" % args.cls),
        best_name=os.path.join(checkpoint_fd, "mde6d_%s_best" % args.cls),
